jlox is an tree-walking interpreter written in java for custom built language lox. both the language and interpreter are implemented in a book "[crafting interpreters](https://craftinginterpreters.com/)" by [Bob Nystrom](https://stuffwithstuff.com/).
